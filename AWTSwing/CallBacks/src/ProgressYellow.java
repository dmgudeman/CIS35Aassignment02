...
public class ProgressYellow extends JPanel implements ActionListener, Callback
{
	MainProgress window = null;
	JButton updatebutton = null;
	int amount = 0;
	
	public ProgressYellow(MainProgress mp)
	{
		window = mp;
		initGUI();
	}
	...
	{
	    JFrame frame = new JFrame("Update Yellow");
