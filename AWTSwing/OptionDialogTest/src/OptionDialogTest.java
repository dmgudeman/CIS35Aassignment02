...
public class OptionDialogTest extends JFrame implements ActionListener
{  
	...
	{  
		...
		optionsPanel = new ButtonPanel("Option", new String[] 
				{  
				"String[]", 
				"Icon[]", 
				"Object[]" 
   ...
   private Font messageFont = new Font("Serif", Font.PLAIN, 8);
   private Component messageComponent = new JPanel()
   {  
