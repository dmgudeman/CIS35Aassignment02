      ...
      //  double x1, x2, y1, y2;
        ...
        for (int j = this.list.size() - 1; j > 0; j--)
        {
            if (this.list.get(j)[3] == 0.0)
            {
                ...
                int ix1 = (((int)((this.list.get(baseIndex)[0]-34.5)*100))+0);
                int x1 = ((int)((this.list.get(baseIndex)[0])*1));
                ...
                System.out.println("y1 (int) (this.list.get(baseIndex[1]-104)*100) = " + ((int)(((this.list.get(baseIndex)[1])+107)*100)));
                System.out.println("y2 (int) (this.list.get(closestIndex[1]-104)*100) = " + ((int)(((this.list.get(closestIndex)[1])+107)*100)));
           ...
           //     g2d.transform(at);
            ...
            //
              // g2d.drawLine((int)((this.list.get(baseIndex)[0])*1), (int)((this.list.get(baseIndex)[1])*1), (int)((this.list.get(closestIndex)[0])*1), (int)((this.list.get(closestIndex)[1])*1));
